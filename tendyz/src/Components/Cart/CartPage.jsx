...
export const CartDetails = (()=>{
   ...
   let addcartArrC =[];
    ...
    // let finalCartArr = JSON.parse(localStorage.getItem("finalCart")) || [];
    const removeFunc = (index,el)=>{
        cartArr.splice(index,1);
        localStorage.setItem("finalCart",JSON.stringify(cartArr));
        // console.log("removed",cartArr)
        return(
            ...
            return(
                ...
                <div className="cart_div">
                    ...
                    {e.description} <br /> <br />
                    <button className="remove_btn" onClick={removeFunc}>
                        Remove
                    </button>
                    <br />
                    <br />
        ...
        {cartArr.map((e)=>{
            ...
            return(
                ...
                <div className="cart_div">
                    ...
                    <h3>Price : ${e.price}</h3> <br />
                    {e.description} <br /> <br />
                    <button >-</button> <button onClick={cartFunc} >+</button>
                    <button className="remove_btn" onClick={removeFunc}>
                        Remove
                    </button>
                    <br />
